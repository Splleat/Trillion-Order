...
VALUES (101, 'ORD-MEMBER-COMPLETED-001', 5, null, 'COMPLETED',
...
-- 샘플 주문 1 상품
INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "packaging_type", "orderitem_status")
VALUES (101, 101, 1, '자바의 정석', '/images/book1.jpg', 2, 25000, 5000, CURRENT_TIMESTAMP - INTERVAL '8' DAY, 500, 'WOOD', 'DELIVERED');
INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "packaging_type", "orderitem_status")
VALUES (102, 101, 2, '클린 코드', '/images/book2.jpg', 1, 10000, 0, CURRENT_TIMESTAMP - INTERVAL '8' DAY, 0, null, 'CONFIRMED');
...
INSERT INTO "order" ("order_id", "order_number", "member_id", "non_member_password", "order_status",
                     ...
                     "order_date", "shipping_post_code", "delivery_date", "delivery_fee", "point_usage", "coupon_discount_amount",
                     "origin_price", "total_price")
VALUES (102, 'ORD-MEMBER-CANCELED-002', 5, null, 'CANCELED',
...
-- 샘플 주문 2 상품
INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "packaging_type", "orderitem_status")
VALUES (103, 102, 3, 'HTTP 완벽 가이드', '/images/book3.jpg', 1, 15000, 0, null, 1000, 'STONE', 'CANCELED');

INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "packaging_type", "orderitem_status")
VALUES (104, 102, 4, '객체지향의 사실과 오해', '/images/book4.jpg', 1, 15000, 0, null, 0, null, 'CANCELED');
...
-- 샘플 주문 3 상품
INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "packaging_type", "orderitem_status")
VALUES (105, 103, 1, '자바의 정석', '/images/book1.jpg', 1, 20000, 0, CURRENT_TIMESTAMP - INTERVAL '18' DAY, 0, null, 'CONFIRMED');

INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "packaging_type", "orderitem_status")
VALUES (106, 103, 2, '클린 코드', '/images/book2.jpg', 1, 30000, 0, CURRENT_TIMESTAMP - INTERVAL '18' DAY, 1000, 'STONE', 'RETURNED');