...
VALUES (1, 'ORD-MEMBER-COMPLETED-001', 1, null, 'COMPLETED',
        '회원주문완료자', '010-1111-2222',
        '회원수령완료인', '010-3333-4444', '서울특별시 강남구 테헤란로 123',
        CURRENT_TIMESTAMP - INTERVAL '10' DAY, '06134', CURRENT_TIMESTAMP - INTERVAL '7' DAY, 0, 1000, 0,
        61000, 60000, null);
...
VALUES (1, 1, 1, '자바의 정석', '/images/book1.jpg', 2, 25000, 0, CURRENT_TIMESTAMP - INTERVAL '8' DAY, 500, 'CONFIRMED');

INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "orderitem_status")
VALUES (2, 1, 2, '클린 코드', '/images/book2.jpg', 1, 10000, 0, CURRENT_TIMESTAMP - INTERVAL '8' DAY, 0, 'CONFIRMED');

-- 샘플 주문 2: 회원 주문 - 취소된 상태 (ID: 2)
INSERT INTO "order" ("order_id", "order_number", "member_id", "non_member_password", "order_status",
                     "orderer_name", "orderer_contact",
                     "receiver_name", "receiver_contact", "receiver_address",
                     "order_date", "shipping_post_code", "delivery_date", "delivery_fee", "point_usage", "coupon_discount_amount",
                     "origin_price", "total_price", "coupon_id")
VALUES (2, 'ORD-MEMBER-CANCELED-002', 1, null, 'CANCELED',
...
-- 샘플 주문 2 상품
INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "orderitem_status")
VALUES (3, 2, 3, 'HTTP 완벽 가이드', '/images/book3.jpg', 1, 15000, 0, null, 1000, 'CANCELED');

INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "orderitem_status")
VALUES (4, 2, 4, '객체지향의 사실과 오해', '/images/book4.jpg', 1, 15000, 0, null, 0, 'CANCELED');

-- 샘플 주문 3: 비회원 주문 - 부분 반품 상태 (ID: 3)
INSERT INTO "order" ("order_id", "order_number", "member_id", "non_member_password", "order_status",
                     "orderer_name", "orderer_contact",
                     "receiver_name", "receiver_contact", "receiver_address",
                     "order_date", "shipping_post_code", "delivery_date", "delivery_fee", "point_usage", "coupon_discount_amount",
                     "origin_price", "total_price", "coupon_id")
VALUES (3, 'ORD-GUEST-PARTIAL-003', null, '$2a$12$CHTyAGNLcQI9JdQHplZoCucsC1IgBdfnJPGg4R9WZ01sYOPrWYmR2', 'COMPLETED', -- 비밀번호: 1234
...
-- 샘플 주문 3 상품
INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "orderitem_status")
VALUES (5, 3, 1, '자바의 정석', '/images/book1.jpg', 1, 20000, 0, CURRENT_TIMESTAMP - INTERVAL '18' DAY, 0, 'CONFIRMED');

INSERT INTO "order_item" ("orderitem_id", "order_id", "book_id", "book_name", "book_image", "quantity", "price", "coupon_discount_amount", "shipping_date", "packaging_price", "orderitem_status")
VALUES (6, 3, 2, '클린 코드', '/images/book2.jpg', 1, 30000, 0, CURRENT_TIMESTAMP - INTERVAL '18' DAY, 1000, 'RETURNED');
